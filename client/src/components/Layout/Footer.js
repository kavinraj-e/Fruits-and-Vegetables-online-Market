...
const Footer = () => {
  return (
    <footer className="bg-gray-900 text-white pt-12 pb-8 px-4">
      ...
      <Link to="/" className="text-3xl font-bold font-heading">
        ...
        <div className="w-2/3 block sm:flex text-sm mt-6 lg:mt-0">
          ...
          <ul className="text-gray-700 list-none p-0 font-thin flex flex-col text-left w-full">
            ...
            <li><Link to="#" className="inline-block py-2 px-3 text-gray-500 hover:text-white no-underline">Privacy</Link></li>
          ...
          <ul className="text-gray-700 list-none p-0 font-thin flex flex-col text-left w-full">
            ...
            <li><Link to="#" className="inline-block py-2 px-3 text-gray-500 hover:text-white no-underline">Developer API</Link></li>
            <li><Link to="#" className="inline-block py-2 px-3 text-gray-500 hover:text-white no-underline">Documentation</Link></li>
            <li><Link to="#" className="inline-block py-2 px-3 text-gray-500 hover:text-white no-underline">Guides</Link></li>
          </ul>
          <div className="text-gray-700 flex flex-col w-full">
            ...
            <div className="flex pl-4 justify-start mt-2">
              <Link className=" flex items-center text-gray-300 hover:text-white mr-6 no-underline" to="#">
              ...
              <Link className=" flex items-center text-gray-300 hover:text-white no-underline" to="#">
                <svg viewBox="0 0 24 24" className="fill-current w-5 h-5" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className=" mt-4 pt-6 text-gray-600 border-t border-gray-800 text-center"> © 2024 Fruxo. All rights reserved.</div>
    </footer>
  );
}
